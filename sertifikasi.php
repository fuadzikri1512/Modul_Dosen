        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Professional Certification</li>
                </ol>
            </section>
            ...
            <div class="box-header">
                ...
                <thead class="bg-aqua-gradient">
                    <tr>
                        ...
                        <th rowspan="2" style="vertical-align: middle;">Nama Sertifikasi</th>
                        <th rowspan="2" style="vertical-align: middle;">Certified by</th>
                        <th rowspan="2" style="vertical-align: middle;">Valid until</th>
                        ...
                        <div class="modal-body">
                            <form action="#" class="form-horizontal">
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="control-label" for="terapan">Nama Sertifikasi</label>
                                    </div>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="control-label" for="terapan">Certified By</label>
                                    </div>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" id="terapan">
                                    </div>
                                ...
                                <div class="form-group row has-feedback">
                                    <div class="col-lg-3">
                                        <label for="tahun" class="control-label">Valid Until</label>
                                    </div>
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3">
                                        <label class="control-label" for="terapan">File</label>
                                    </div>
                                    <div class="col-lg-6">
